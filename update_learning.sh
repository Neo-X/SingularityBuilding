...
#
sudo singularity shell --writable /scratch/gberseth/playground/singularity/ubuntu_learning.img -c "pushd /opt/TerrainRL; git pull origin master; pushd simAdapter/; ./gen_swig.sh; popd; premake4 gmake; pushd gmake; make config=release64 -j 8; popd; popd; pushd RLSimulationEnvironments; git pull origin master; pushd rendering; premake4 gmake; make config=release64 -j 2; popd; popd;"
